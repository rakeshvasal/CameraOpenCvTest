...
public class QuadrilateralView extends android.support.v7.widget.AppCompatImageView {
    ...
    public QuadrilateralView(Context context, AttributeSet attrs, int defStyle) {
